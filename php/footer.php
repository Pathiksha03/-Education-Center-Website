    ...
    <footer>
        <div class="footer-container">
            <div class="footer-section about">
                <h3>About Us</h3>
                <p>Welcome to our Educational Tutorial Center, where we ignite a passion for learning and help students excel academically.
                    Join us to unlock new opportunities and achieve your educational goals..</p>
                <ul class="socials">
            ...
            <div class="footer-section contact">
                <h3>Contact Us</h3>
                <p>Email: diyak@gmail.com</p>
                <p>Phone: 0556566652</p>
                <p>Address:Dubai,Kurukku sandhu valluvar puram ,Dubai.</p>
            </div>
        </div>
